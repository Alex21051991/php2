...
use App\Blog\Repositories\CommentsRepository\SqliteCommentRepository;
...
class SqliteCommentsRepository implements CommentsRepositoryInterface
{
     ...
     * @throws Exception
     */
    private function getComment(\PDOStatement $statement, string $str): Comment
    {
            $result = $statement->fetch(\PDO::FETCH_ASSOC);

            if ($result === false) {
                throw new Exception("Cannot find comment: $str");
            }
