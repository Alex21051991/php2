...
class SqlitePostsRepository implements PostsRepositoryInterface//, UsersRepositoryInterface
{
    ...
    private function getPost(PDOStatement $statement, string $postUuId): Post
    {
        ...
        if ($result === false) {
           throw new InvalidArgumentException("Cannot find post number: $postUuId");
        }
